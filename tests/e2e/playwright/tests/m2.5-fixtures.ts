// @ctx: M2.5 E2E test fixtures — mock auth, deterministic GUI GraphQL data
//
// IN REAL-BACKEND MODE (playwright.m2.5.real.config.ts):
...
//
// M2.5 GUI specs verify page wiring and UX states for dashboard-level GraphQL
