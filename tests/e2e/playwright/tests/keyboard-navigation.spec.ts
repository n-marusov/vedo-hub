// @ctx: Playwright E2E tests for keyboard navigation per UX-A11Y-001 Invariant 1
// @hlv:artifact tests-a11y verifies UX-A11Y-001
import { test, expect } from '@playwright/test'

// @hlv A1 keyboard navigation — all interactive elements reachable via Tab
