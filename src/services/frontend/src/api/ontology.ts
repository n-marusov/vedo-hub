...
export async function createClass(
	...
	try {
		...
		const message =
			serverMessage ?? axiosErr.message ?? "Failed to create class";
...
export async function createProperty(
	...
	try {
		...
		const serverMessage = axiosErr.response?.data?.error?.message;
		const message =
			serverMessage ?? axiosErr.message ?? "Failed to create property";
...
export async function createIndividual(
	...
	try {
		...
		const serverMessage = axiosErr.response?.data?.error?.message;
		const message =
			serverMessage ?? axiosErr.message ?? "Failed to create individual";
