...
const navItems = computed<NavItem[]>(() => {
  ...
  return [
    { label: 'Members', icon: Users, to: `${base}/members`, badge: '0' },
    { label: 'Merge requests', icon: GitMerge, to: `${base}/merge_requests`, badge: '0' },
    { label: 'Commits', icon: History, to: `${base}/commits`, badge: '0' },
    { label: 'Comments', icon: MessageSquare, to: `${base}/comments`, badge: '0' }
  ]
})
