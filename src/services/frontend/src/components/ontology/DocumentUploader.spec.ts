...
describe("DocumentUploader", () => {
	...
	describe("Props", () => {
		it("renders with default props", () => {
			...
			expect(wrapper.find(".uploader__title").text()).toContain(
	...
	describe("File Validation", () => {
		it("shows error state for unsupported format", async () => {
			...
			expect(wrapper.find(".uploader__error-message").text()).toContain(
				"Unsupported format",
			);
		});
	...
	describe("Success State", () => {
		it("shows success state on successful upload", async () => {
			...
			expect(wrapper.find(".uploader__success-text").text()).toContain(
				"2 steps",
			);
		});
	});
