...
func (x *ForkProjectRequest) Reset() {
	*x = ForkProjectRequest{}
	mi := &file_auth_v1_org_proto_msgTypes[45]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ForkProjectRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ForkProjectRequest) ProtoMessage() {}

func (x *ForkProjectRequest) ProtoReflect() protoreflect.Message {
	mi := &file_auth_v1_org_proto_msgTypes[45]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ForkProjectRequest.ProtoReflect.Descriptor instead.
func (*ForkProjectRequest) Descriptor() ([]byte, []int) {
	return file_auth_v1_org_proto_rawDescGZIP(), []int{45}
}

func (x *ForkProjectRequest) GetSourceProjectId() string {
	if x != nil {
...
func (x *ForkProjectRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *ForkProjectRequest) GetOrganizationId() string {
	if x != nil {
		return x.OrganizationId
	}
	return ""
...
func (x *ForkProjectResponse) Reset() {
	*x = ForkProjectResponse{}
	mi := &file_auth_v1_org_proto_msgTypes[46]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ForkProjectResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ForkProjectResponse) ProtoMessage() {}

func (x *ForkProjectResponse) ProtoReflect() protoreflect.Message {
	mi := &file_auth_v1_org_proto_msgTypes[46]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ForkProjectResponse.ProtoReflect.Descriptor instead.
func (*ForkProjectResponse) Descriptor() ([]byte, []int) {
	return file_auth_v1_org_proto_rawDescGZIP(), []int{46}
}

func (x *ForkProjectResponse) GetProject() *Scope {
	if x != nil {
		return x.Project
	}
	return nil
...
func (x *ForkProjectResponse) GetError() *v1.ErrorDetail {
	if x != nil {
		return x.Error
	}
	return nil
...
const file_auth_v1_org_proto_rawDesc = "" +
	...
	"\x05error\x18\x03 \x01(\v2\x1b.vedo.common.v1.ErrorDetailR\x05error\"\x82\x01\n" +
	"\x12ForkProjectRequest\x12*\n" +
	"\x11source_project_id\x18\x01 \x01(\tR\x0fsourceProjectId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12'\n" +
