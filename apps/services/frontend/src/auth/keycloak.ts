...
export function getConfig(): KeycloakConfig {
	const runtime = window.__VEDO_CONFIG__ || {};
	return {
		realm: runtime.KEYCLOAK_REALM || DEFAULT_CONFIG.realm,
		clientId: runtime.KEYCLOAK_CLIENT_ID || DEFAULT_CONFIG.clientId,
		url: runtime.KEYCLOAK_URL || DEFAULT_CONFIG.url,
