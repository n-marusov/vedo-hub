...
describe('SequencePreview', () => {
  ...
  describe('Toggle step inclusion', () => {
    ...
    it('apply button is disabled when no steps included', () => {
      const steps = [createStep({ id: 's1', label: 'Step 1', included: false })]
  ...
  describe('Duplicate detection', () => {
    it('shows duplicate badge for duplicate steps', () => {
      ...
      expect(wrapper.find('.preview__duplicates-info').text()).toContain('1 duplicate')
    })
    ...
    it('shows correct duplicate count for multiple duplicates', () => {
      ...
      expect(wrapper.find('.preview__duplicates-info').text()).toContain('2 duplicates')
    })
  })
  ...
  describe('Select all / Deselect all', () => {
    it('select all button sets all steps to included', async () => {
      ...
      expect(wrapper.find('.preview__apply-btn').attributes('disabled')).toBeUndefined()
    })
    ...
    it('deselect all sets all steps to excluded', async () => {
      ...
      expect(wrapper.find('.preview__apply-btn').attributes('disabled')).toBeDefined()
    })
  })
