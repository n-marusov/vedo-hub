...
export async function listCommits(
  ...
  console.info(JSON.stringify({
    level: "info", msg: "versioning.commits.list.request",
    ontologyId, branchId, page, perPage, ts: new Date().toISOString(),
  }));
  ...
  try {
    ...
    console.info(JSON.stringify({
      level: "info", msg: "versioning.commits.list.success",
      ontologyId, total: data.total, ts: new Date().toISOString(),
    }));
    return data;
  } catch (err: any) {
    const msg = err.response?.data?.error?.message ?? err.message ?? "Failed to list commits";
    console.error(JSON.stringify({
      level: "error", msg: "versioning.commits.list.failed",
...
export async function listBranches(
  ...
  console.info(JSON.stringify({
    level: "info", msg: "versioning.branches.list.request",
    ontologyId, referenceBranchId, ts: new Date().toISOString(),
  }));
  ...
  try {
    ...
    console.info(JSON.stringify({
      level: "info", msg: "versioning.branches.list.success",
      ontologyId, total: data.total, ts: new Date().toISOString(),
    }));
    return data;
  } catch (err: any) {
    ...
    console.error(JSON.stringify({
      level: "error", msg: "versioning.branches.list.failed",
      ontologyId, error: msg, ts: new Date().toISOString(),
    }));
    throw new Error(msg);
  }
...
export async function getBranch(
  ...
  console.info(JSON.stringify({
    level: "info", msg: "versioning.branch.get.request",
    branchId, ts: new Date().toISOString(),
  }));

  try {
    const { data } = await api.get(`/versioning/branches/${branchId}`);
    console.info(JSON.stringify({
      level: "info", msg: "versioning.branch.get.success",
      branchId, ts: new Date().toISOString(),
    }));
    return data;
  } catch (err: any) {
    ...
    console.error(JSON.stringify({
      level: "error", msg: "versioning.branch.get.failed",
      branchId, error: msg, ts: new Date().toISOString(),
    }));
    throw new Error(msg);
  }
}
...
export async function listTags(
  ...
  console.info(JSON.stringify({
    level: "info", msg: "versioning.tags.list.request",
  ...
  try {
    ...
    console.info(JSON.stringify({
      level: "info", msg: "versioning.tags.list.success",
      ontologyId, count: data.length, ts: new Date().toISOString(),
    }));
    return data;
  } catch (err: any) {
    const msg = err.response?.data?.error?.message ?? err.message ?? "Failed to list tags";
    console.error(JSON.stringify({
      level: "error", msg: "versioning.tags.list.failed",
      ontologyId, error: msg, ts: new Date().toISOString(),
    }));
    throw new Error(msg);
  }
...
export async function compareRevisions(
  ...
  console.info(JSON.stringify({
    level: "info", msg: "versioning.compare.request",
    ontologyId, fromRevision, toRevision, ts: new Date().toISOString(),
  }));
  ...
  try {
    ...
    console.info(JSON.stringify({
      level: "info", msg: "versioning.compare.success",
      ontologyId, additions: data.additions, deletions: data.deletions,
    ...
    console.error(JSON.stringify({
      level: "error", msg: "versioning.compare.failed",
      ontologyId, error: msg, ts: new Date().toISOString(),
    }));
    throw new Error(msg);
  }
