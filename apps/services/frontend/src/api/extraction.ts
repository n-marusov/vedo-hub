...
export async function uploadDocument(options: UploadOptions): Promise<ExtractionPreview> {
...
export async function applySequence(options: ApplySequenceOptions): Promise<ApplyResult> {
...
export const ALLOWED_FORMATS = ['.md', '.txt', '.pdf', '.docx', '.json', '.xml', '.csv', '.xlsx']
