...
export async function generateFromText(request: AiGenerationRequest): Promise<AiGenerationResult> {
...
export async function refineSequence(request: AiRefinementRequest): Promise<AiRefinementResult> {
...
export async function suggestClasses(request: AiSuggestionRequest): Promise<AiSuggestionResult> {
...
export async function suggestProperties(request: AiSuggestionRequest): Promise<AiSuggestionResult> {
