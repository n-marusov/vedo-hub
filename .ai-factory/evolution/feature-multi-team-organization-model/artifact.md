...
- [x] **Task 1: Set up Playwright test infrastructure for M2.1 org model** — addresses REQ-NFR.SECURITY.organization-access-model (test infra for org model E2E)
  **Subtasks (ordered):**
...
- [ ] **Task 23: Align roadmap references and user-facing terminology with M3/MVP** — addresses REQ-NFR.DOC.terminology-consistency (M3 terminology alignment)
  **Subtasks (ordered):**
...
- [ ] **Task 24: Reconcile MVP role vocabulary with existing authorization roles** — implements REQ-FUN.AUTH.mvp-role-vocabulary (MVP role reconciliation)
  **Subtasks (ordered):**
...
- [ ] **Task 25: Enforce MVP group hierarchy and project movement rules** — implements REQ-FUN.ORG.hierarchy-depth-limit (group nesting + project move)
  **Subtasks (ordered):**
...
- [ ] **Task 26: Complete audit coverage for MVP org lifecycle events** — implements REQ-NFR.AUDIT.org-lifecycle (audit coverage for org events)
  **Subtasks (ordered):**
...
- [ ] **Task 27: Update acceptance criteria and traceability for final MVP scope** — implements REQ-NFR.TRACE.mvp-scope (final acceptance criteria and traceability)
  **Subtasks (ordered):**
